 ...
 public class JoypadScriptCs : MonoBehaviour {
	 ...
	 * maroien88@Gmail.com 	 */
	 ...
	 private KeyCode Joy1ButtonA;
	 private KeyCode Joy1ButtonB;
	 private KeyCode Joy1ButtonX;
	 private KeyCode Joy1ButtonY;
	 private KeyCode Joy1ButtonL1;
	 private KeyCode Joy1ButtonL2;
	 private KeyCode Joy1ButtonR1;
	 private KeyCode Joy1ButtonR2;
	 private KeyCode Joy1ButtonStart;
	 private KeyCode Joy1ButtonSelect;
	 private KeyCode Joy2ButtonA;
	 private KeyCode Joy2ButtonB;
	 private KeyCode Joy2ButtonX;
	 private KeyCode Joy2ButtonY;
	 private KeyCode Joy2ButtonL1;
	 private KeyCode Joy2ButtonL2;
	 private KeyCode Joy2ButtonR1;
	 private KeyCode Joy2ButtonR2;
	 private KeyCode Joy2ButtonStart;
	 private KeyCode Joy2ButtonSelect;
	 private KeyCode Joy3ButtonA;
	 private KeyCode Joy3ButtonB;
	 private KeyCode Joy3ButtonX;
	 private KeyCode Joy3ButtonY;
	 private KeyCode Joy3ButtonL1;
	 private KeyCode Joy3ButtonL2;
	 private KeyCode Joy3ButtonR1;
	 private KeyCode Joy3ButtonR2;
	 private KeyCode Joy3ButtonStart;
	 private KeyCode Joy3ButtonSelect;
	 private KeyCode Joy4ButtonA;
	 private KeyCode Joy4ButtonB;
	 private KeyCode Joy4ButtonX;
	 private KeyCode Joy4ButtonY;
	 private KeyCode Joy4ButtonL1;
	 private KeyCode Joy4ButtonL2;
	 private KeyCode Joy4ButtonR1;
	 private KeyCode Joy4ButtonR2;
	 private KeyCode Joy4ButtonStart;
	 private KeyCode Joy4ButtonSelect;
	 public KeyCode ButtonA;
	 public KeyCode ButtonB;
	 public KeyCode ButtonX;
	 public KeyCode ButtonY;
	 public KeyCode ButtonL1;
	 public KeyCode ButtonL2;
	 public KeyCode ButtonR1;
	 public KeyCode ButtonR2;
	 public KeyCode ButtonStart;
	 public KeyCode ButtonSelect;
	 ...
	 public void saveButton ( string NameButton , KeyCode KeyButton ){
	 ...
	 public bool joyClick=false;
	 public bool joyClickFalseNotActive=false;
	 public bool joyMenuNotActive=false;
	 public bool mouseMenuNotActive=false;
	 public bool mouseMenuNotActiveAlways=false;
	 public int joyMenuSelected=0;
	 public int joyMenuCount=16;
	 private float DeltaRateAxis=0;
	 public float rateAxis=0.2f;
	 public int joyVerticalStep=1;
	 public float axisSensitivity=0.4f;
	 public void JoyMenu (){
		 ...
		 else if(joyClickFalseNotActive)joyClick=false;
	 ...
	 public Joypad getJoystickSelected ( int ply ){
		 ...
		 for (int i = 1;
				 i <= 4;
				 i++) {
			 if (Mathf.Abs(Input.GetAxis("Joy"+i+"X")) > 0.7f || Mathf.Abs(Input.GetAxis("Joy"+i+"Y")) > 0.7f){
	 ...
	 public Joypad getJoystickSelectedx (){
		 waitButtonDelay=0.6f;
		 if(Input.GetKey(KeyCode.JoystickButton1)||Input.GetKey(KeyCode.JoystickButton0)){
			 if(Input.GetKey(KeyCode.Joystick1Button0)||Input.GetKey(KeyCode.Joystick1Button1)) {
	 ...
	 public string[] joypadName=new string[4];
	 ...
	 private float waitButtonDelay=0;
	 ...
	 private int buttonNotFoundedCOUNT=0;
	 private KeyCode buttonFounded;
